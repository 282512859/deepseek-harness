...
import balanceBadgeRemote from '@deepseek-ai/dsh-balance-badge/remote'
...
export type {} from '@deepseek-ai/dsh-balance-badge/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, balanceBadgeRemote,
    ]) {
